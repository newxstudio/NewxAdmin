<?php /*a:3:{s:55:"D:\wamp64\www\NEWX\application\admin\view\user\lst.html";i:1551425280;s:57:"D:\wamp64\www\NEWX\application\admin\view\common\top.html";i:1551428493;s:58:"D:\wamp64\www\NEWX\application\admin\view\common\left.html";i:1551451623;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<button type="button" tooltip="添加管理员" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('user/signin'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center"><?php echo htmlentities($vo['sex']); ?></td>
                                <td align="center"><?php echo htmlentities($vo['department']); ?></td>
                                <td align="center"><?php echo htmlentities($vo['class']); ?></td>
                                
                                <td align="center">
                                    <a href="<?php echo url('user/edit',array('id'=>$vo['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                   
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url("user/del",array('id'=>$vo['id'])); ?>')" class="btn btn-danger btn-sm shiny">
