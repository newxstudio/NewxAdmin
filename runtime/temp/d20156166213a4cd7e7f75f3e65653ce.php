<?php /*a:1:{s:63:"D:\wamp64\www\NewxAdmin\application\admin\view\login\login.html";i:1566654968;}*/ ?>
...
<head>
  ...
  <link rel="stylesheet" href="http://localhost/newxadmin/public/static/layuiadmin/style/login.css" media="all">
</head>
<body>
  ...
  <div class="layadmin-user-login layadmin-user-display-show" id="LAY-user-login" style="display: none;">
    ...
    <div class="layui-trans layadmin-user-login-footer">
      ...
      <p> Copyright © 2019<a href="#" >NEWX大学生网络文化工作室 </a>版权所有</p>
  ...
  layui.config({
    ...
    form.on('submit(LAY-user-login-submit)', function(obj){
      ...
      //请求登入接口
      admin.req({
        url: "http://localhost/newxadmin/public/admin/Login/tologin" //实际使用请改成服务端真实接口
        ,data: obj.field
        ,done: function(res){
