<?php /*a:3:{s:60:"D:\wamp64\www\NEWX\application\admin\view\auth_rule\lst.html";i:1552272615;s:57:"D:\wamp64\www\NEWX\application\admin\view\common\top.html";i:1552389751;s:58:"D:\wamp64\www\NEWX\application\admin\view\common\left.html";i:1552270767;}*/ ?>
<!DOCTYPE html>
<html>
												...
												<form action="" method="post">
													<table class="table table-bordered table-hover">
														...
														<tbody>
															...
															<tr>
																<td align="center"><?php echo htmlentities($authRule['id']); ?></td>
																<td align="center"><input name="<?php echo htmlentities($authRule['id']); ?>" type="text" style="width:50px; text-align:center;" value="<?php echo htmlentities($authRule['sort']); ?>"></td>
																<td>
																	<?php if($authRule['level']!=0){echo '|';} echo str_repeat('—', $authRule['level']*3)?><?php echo htmlentities($authRule['title']); ?></td>
																<td><?php echo htmlentities($authRule['name']); ?></td>
																<td align="center"><?php echo htmlentities($authRule['level']+1); ?>级</td>
																<td align="center">
																	<a href="<?php echo url('edit',array('id'=>$authRule['id'])); ?>" class="btn btn-primary btn-sm shiny">
																		<i class="fa fa-edit"></i> 编辑
																	</a>
																	
																	<a href="#" <?php if($auth == 0): ?> onClick="layer.open({title: '<?php echo htmlentities($groupTitle); ?>',content:'没有权限',icon: 5,anim: 6});" <?php else: ?> onClick="warning('确实要删除吗', '<?php echo url('del',array('id'=>$authRule['id'])); ?>')"<?php endif; ?> class="btn btn-danger btn-sm shiny">
