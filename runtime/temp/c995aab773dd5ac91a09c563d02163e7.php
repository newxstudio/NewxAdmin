<?php /*a:1:{s:65:"D:\wamp64\www\NewxAdmin\application\admin\view\auth_rule\add.html";i:1564966242;}*/ ?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <link  href="http://localhost/newxadmin/public/static/admin/style/beyond.css" rel="stylesheet">
                                ...
                                <div class="widget-body">
                                    <div id="horizontal-form">
                                        <form class="form-horizontal" role="form" action="" method="post">
                                                ...
                                                <div class="col-sm-6">
                                                    <select name="pid">
                                                        ...
                                                        <option value="<?php echo htmlentities($authRule['id']); ?>">
                                                            <?php if($authRule['level']!=0){echo '|';} echo str_repeat('—', $authRule['level']*3)?>
                                                            <?php echo htmlentities($authRule['title']); ?>
                                                        </option>
                                            ...
                                            <div class="form-group">
                                                <label for="state"
                                                       class="col-sm-2 control-label no-padding-right">是否可见</label>
                                                <div class="col-sm-6">
                                                    <label>
                                                        <input class="checkbox-slider colored-darkorange"
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-offset-2 col-sm-10">
                                                    <button type="submit" class="btn btn-default" id="toSave">保存信息
                                                    </button>
                                                </div>
                                            </div>
                                        </form>
