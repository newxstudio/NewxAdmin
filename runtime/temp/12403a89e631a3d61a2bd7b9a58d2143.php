<?php /*a:3:{s:56:"D:\wamp64\www\NEWX\application\admin\view\user\edit.html";i:1551425271;s:57:"D:\wamp64\www\NEWX\application\admin\view\common\top.html";i:1551069475;s:58:"D:\wamp64\www\NEWX\application\admin\view\common\left.html";i:1551335181;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" enctype="multipart/form-data" method="post">
                    	<input type="hidden" name="id" value="<?php echo htmlentities($users['id']); ?>" />
                       <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">登录名</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="username"  name="username" disabled="disabled" value="<?php echo htmlentities($users['username']); ?>" type="text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="name"  name="name" value="<?php echo htmlentities($users['name']); ?>" type="text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="sex"  name="sex" value="<?php echo htmlentities($users['sex']); ?>" type="text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="date"  name="date" value="<?php echo htmlentities($users['date']); ?>" type="text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="phone"  name="phone" value="<?php echo htmlentities($users['phone']); ?>" type="text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="department"  name="department" value="<?php echo htmlentities($users['department']); ?>" type="text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="class"  name="class" value="<?php echo htmlentities($users['class']); ?>" type="text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="bedroom"  name="bedroom" value="<?php echo htmlentities($users['bedroom']); ?>"  type="text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="id_number"  name="id_number" value="<?php echo htmlentities($users['id_number']); ?>" type="text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="email"  name="email" value="<?php echo htmlentities($users['email']); ?>" type="text">
