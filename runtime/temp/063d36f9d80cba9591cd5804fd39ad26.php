<?php /*a:3:{s:60:"D:\wamp64\www\NEWX\application\admin\view\apply\select1.html";i:1551421707;s:57:"D:\wamp64\www\NEWX\application\admin\view\common\top.html";i:1551069475;s:58:"D:\wamp64\www\NEWX\application\admin\view\common\left.html";i:1551335181;}*/ ?>
<!DOCTYPE html>
<html>

	<head>
		<meta charset="utf-8">
		<title>NEWX·后台管理 -报名列表-查询 </title>
                ...
                <!-- /Sidebar Menu -->
					...
					<div class="page-content">
						...
						<div class="page-body">
							...
							<form action="<?php echo url('apply/select1'); ?>" method="post">
								<span>第一志愿:</span>
													...
													<tbody>
														...
														<tr>
															...
															<td align="center">
																...
																<a href="#" onClick="warning('确实要删除吗', '<?php echo url(" apply/del ",array('id'=>$vo['id'])); ?>')" class="btn btn-danger btn-sm shiny">
				...
				function adddhm() {
					...
					*/
					...
					$.ajax({
						...
						url: "<?php echo url('apply/select1'); ?>",
