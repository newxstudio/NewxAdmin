<?php /*a:1:{s:63:"D:\wamp64\www\NewxAdmin\application\index\view\index\index.html";i:1564826691;}*/ ?>
<!DOCTYPE html>
<html>
...
<!--							</li>-->
		...
		<div id="container">
			...
			<div class="section" id="section2">
				...
				<section id="knowledge_x" class="viewBlock_x">
					<div class="bookBox_x">
						<a class="lastBtn_x">
							<</a>
								<a class="nextBtn_x">></a>
					...
					<li class="f-main-item_x f-main-itemHover_x">
						<div class="fk-infoBlockWrap_x">
							...
							<div class="fk-infoBlock_x f-infoBlock-normal_x">
								<div class="f-bg_x"></div>
								<div class="f-infoWrap_x">
									<div class="f-info-title_x">我们负责查水表嗷~</div>
									<div class="f-info-desc_x">
										<p>处理工作室日常运营部分的相关工作</p>
										<p>安排值班表并监督</p>
										<p>偷懒的一律扣鸡腿!!</p>
									</div>
								</div>
