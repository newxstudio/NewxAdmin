<?php /*a:1:{s:70:"D:\wamp64\www\NewxAdmin\application\admin\view\auth_rule\roleform.html";i:1564970615;}*/ ?>
...
<body>
  ...
  <div class="layui-form" lay-filter="layuiadmin-form-role" id="layuiadmin-form-role" style="padding: 20px 30px 0 0;">
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <input type="text" name="name" lay-verify="required" placeholder="请输入控制器/方法" autocomplete="off" class="layui-input">
      </div>
    </div>
    <div class="layui-form-item">
      <label class="layui-form-label">是否可见</label>
      <div class="layui-input-inline">
        <input type="checkbox" lay-filter="switch" name="visibility" value="1" lay-skin="switch" lay-text="可见|不可见">
      </div>
    </div>
