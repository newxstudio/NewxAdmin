<?php /*a:1:{s:73:"D:\wamp64\www\NewxAdmin\application\admin\view\apply\showoptionapply.html";i:1566390352;}*/ ?>
<!doctype html>
<html>
	<head>
		<meta charset="utf-8">
	...
	<body>
		<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$apply): $mod = ($i % 2 );++$i;?>
