<?php /*a:1:{s:75:"D:\wamp64\www\NewxAdmin\application\admin\view\auth_group\addrulegroup.html";i:1564995832;}*/ ?>
      ...
      <table class="layui-table" style="margin-left: 30px;">
        ...
        <tr>
          <td>
              ...
              <input name="rules[]" value="<?php echo htmlentities($authRule['id']); ?>" <?php if($authRule['level'] != 0): ?> lay-filter="LAY-user-child" <?php else: ?> lay-filter="LAY-user-parent"  <?php endif; ?>  dataid="id-<?php echo htmlentities($authRule['dataid']); ?>" lay-skin="primary" class="checkbox-parent " type="checkbox">
