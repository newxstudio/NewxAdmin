...
/*
  ...
  -- ----------------------------
  DROP TABLE IF EXISTS `newx_auth_rule`;
  ...
  -- ----------------------------
  -- newx_auth_group 用户组表，
  -- id：主键， title:用户组中文名称， rules：用户组拥有的规则id， 多个规则","隔开，status 状态：为1正常，为0禁用
  -- ----------------------------
  DROP TABLE IF EXISTS `newx_auth_group`;
  ...
  -- ----------------------------
  -- newx_auth_group_access 用户组明细表
  -- uid:用户id，group_id：用户组id
  -- ----------------------------
  DROP TABLE IF EXISTS `newx_auth_group_access`;
